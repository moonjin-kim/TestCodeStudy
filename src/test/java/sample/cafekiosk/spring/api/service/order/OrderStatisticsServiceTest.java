...
class OrderStatisticsServiceTest {
    ...
    void sendOrderStatisticsMail(){
        //given
        LocalDateTime registeredDateTime = LocalDateTime.of(2023,9,14,0,0);
        ...
        Order order1 = createPaymentCompletedOrder(products, LocalDateTime.of(2023,9,13,23,59,59));
        Order order2 = createPaymentCompletedOrder(products, registeredDateTime);
        Order order4 = createPaymentCompletedOrder(products, LocalDateTime.of(2023,9,14,23,59,59));
        Order order3 = createPaymentCompletedOrder(products, LocalDateTime.of(2023,9,15,0,0));
        ...
        //when
        boolean result = orderStatisticsService.sendOrderStatisticsMail(LocalDate.of(2023,9,14),"test@test.com");
